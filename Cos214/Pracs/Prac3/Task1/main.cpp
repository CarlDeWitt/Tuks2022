...
Confectionery** confextions[1];
 ...
 void run(){
    ...
    if(input == "lindt" || input == "l"){
        cout << "You have selected Lindt" << endl << "Do you want a lint Slab Y/N:";
        cin >> input2;
        ...
        cout << "You have selected Cadbury" << endl << "Do you want a Aerated chocolate Y/N:";
        cin >> input2;
        if(input2 == "Y" || input2 == "y"){
            cout << "Nice job you have selected Aerated chocolate" << endl << "How much air do you want to add in cm: " ;
            cin >> input4;
            confext1ons = factory[0]->createAeratedChocolate(input4);
             confext1ons->getDescription();
        }else{
            cout << "Nice job you have selected Chocolate" << endl << "Do you want a Slab Y/N:";
            cin >> input3;
        ...
        cout << "You have selected Nestle" << endl << "Do you want a Aerated chocolate Y/N:";
        cin >> input2;
        if(input2 == "Y" || input2 == "y"){
            cout << "Nice job you have selected Aerated chocolate" << endl << "How much air do you want to add in cm: " ;
            cin >> input4;
