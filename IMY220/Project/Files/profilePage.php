        ...
        <div class="container leftside pannel">
          ...
          <div class="row backbtn">
            <div class="col-12 imgDiv centerDiv">
              <a id="Alogo" onclick="history.back()" class="hoverClass"><i class="fa-solid fa-arrow-left" id="logo"></i></a>
              ...
              <img src="Media/Images/profile/pfp.jpg" alt="Profile Image" class="profileImg" />
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-12 btns">
              <button type="button" id="chatOut">
                <i id="chatBTN" class="fa-regular hoverClass fa-comment"></i>chat
              </button>
