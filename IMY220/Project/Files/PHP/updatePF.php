<?php
    ...
    $img = $_FILES['Rateimg']['name'];

    $target_dir = "../Media/Images/profile/";
    ...
    $query = $U_pfp . " SET pfpImg = '$img', description = '$description' WHERE id = $UID";
    $result = mysqli_query($mysqli, $query);

    header('Location: ../profilePage.php?UID='.$UID);
?>