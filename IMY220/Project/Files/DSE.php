...
<html>
  ...
  <body>
    <div class="container outer">
      <a href="home.php"><img class="exit" src="Media/Images/logo_v2.png" alt="logo" id="logo" /></a>
          ...
          <div class="container-fluid inner">
            ...
            <div class="row">
              <div class="col-10 offset-1 data buttons">
                <i class="fa-solid fa-heart" onclick="heart()"></i
                ><i class="fa-solid fa-clipboard-user" onclick="addlist(<?php echo $EID; ?>)"></i>
              </div>
            </div>
          </div>
        </div>
